...
const TopMenu = () => {
  ...
  return (
    <div className='px-[40px] bg-light-bg py-4 z-10 max-xs:px-[20px] '>
      <div className='top-menu'>
        <div className='flex justify-between items-center w-full md:hidden'>
          <div className='flex gap-10 w-full'>
            {/* link */}
            <Link href={'/'}>
              <h1 className='font-bold text-3xl text-dark-red'>Rakshith.S</h1>
            </Link>
          </div>
        ...
        <div className='top-menu-info-container'>
          <div className='flex md:gap-10 flex-col md:flex-row'>
            <div className='flex gap-1 items-center text-sm font-bold'>
              {/* email */}
              <MdEmail />
              <span className='text-dark-blue'>rakshit.s.gowda@gmail.com</span>
            </div>
          </div>
          {/* button for CV */}
